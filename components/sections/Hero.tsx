...
import heroImage1 from "@/app/assets/resized/hero-img-1.jpg";
import heroImage2 from "@/app/assets/resized/hero-image-2.jpg";
import heroImage3 from "@/app/assets/resized/product-collection.jpg";
...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen bg-foreground overflow-hidden md:max-w-full max-w-lg mx-auto">
      <div className="container mx-auto px-4 pb-20 pt-6">
        <div className="text-center mb-16">
          ...
          >
            En <span className="text-primary">enklere</span> hverdag.
          </motion.h1>
          
          <motion.div 

            className="grid grid-cols-1 xl:grid-cols-6 md:gap-4 gap-2 md:gap-y-3 max-w-2xl xl:max-w-7xl mx-4 sm:mx-auto mb-8"
          >
            <motion.div 
          ...
          >
            ...
            <Button
              size="lg"
              className="bg-hero-accent text-white bg-primary font-semibold px-8 py-6 text-lg rounded-md"
