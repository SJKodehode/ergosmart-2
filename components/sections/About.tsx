...
export function About() {
  return (
    <section className="py-20 xl:py-40 bg-primary/10">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <Card className="h-full bg-foreground border-content1/20 border text-background rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
