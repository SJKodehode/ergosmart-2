...
export function Features() {
  return (
    <section className="py-20 md:py-40 bg-primary/10">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <Card className="h-full rounded-2xl border border-content1/20 bg-foreground shadow-lg text-background hover:shadow-xl transition-shadow duration-300">
